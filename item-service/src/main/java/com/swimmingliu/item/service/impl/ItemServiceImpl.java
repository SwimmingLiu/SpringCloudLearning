package com.swimmingliu.item.service.impl;
...
import com.swimmingliu.item.mapper.ItemMapper;
import com.swimmingliu.item.service.IItemService;
...
public class ItemServiceImpl extends ServiceImpl<ItemMapper, Item> implements IItemService {
    ...
    public void deductStock(List<OrderDetailDTO> items) {
        String sqlStatement = "com.swimmingliu.itemservice.mapper.ItemMapper.updateStock";
        boolean r = false;
        try {
